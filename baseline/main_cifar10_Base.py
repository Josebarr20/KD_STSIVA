...
if __name__ == "__main__":
    ...
    parser.add_argument("--project_name", type=str, default="Classification_CIFAR10_Baseline_final")
    parser.add_argument("--type_t", type=str, default="binary")
    parser.add_argument("--real", type=str, default="False") # True for real, False for binary
