...
def main(args):
  ...
  wandb.init(project=args.project_name, name="KD_TEST_" + path_name, config=args)
  ...
  for epoch in range(args.num_epochs):
    ...
    for _, train_data in data_loop_train:
      ...
      loss_train = (args.lambda1*loss_deco + args.lambda2*loss_mse + args.lambda3*loss_kl)
    ...
    with torch.no_grad():
      ...
      for _, val_data in data_loop_val:
        ...
        loss_val = (args.lambda1*loss_deco + args.lambda2*loss_mse + args.lambda3*loss_kl)
  ...
  with torch.no_grad():
    ...
    for _, test_data in data_loop_test:
      ...
      loss_test = (args.lambda1*loss_deco + args.lambda2*loss_mse + args.lambda3*loss_kl)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--project_name", type=str, default="KD_TEST")
