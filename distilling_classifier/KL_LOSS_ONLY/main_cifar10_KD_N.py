...
def main(args):
  ...
  wandb.init(project=args.project_name, name="KD_kl_" + path_name, config=args)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--project_name", type=str, default="KD_KL_TEST")
