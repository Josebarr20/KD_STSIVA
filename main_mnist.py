...
_, im_size, num_classes, class_names, _, _, testloader, trainloader, valoader = get_dataset("MNIST", "data", batch_size, 42)
...
wandb.init(project="Classification_MNIST", name="Prueba 3 - 150_n_e",config={"num_epochs": num_epochs})
